### Auto-generated HTML & Javascript for Cmajor Patch "Electric Piano"
...
- `cmaj_Electric_Piano.js` - this is the Javascript wrapper class for the patch, encapsulating its
