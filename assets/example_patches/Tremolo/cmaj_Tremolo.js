...
class Tremolo
{
  ...
  async initialise (sessionID, frequency)
  {
    ...
    if (exports.advanceBlock)
      this._advance = numFrames => exports.advanceBlock (74592, 74816, numFrames);
    else
      this._advance = () => exports.advanceOneFrame (74592, 74816);

    exports.initialise?.(74592, 78912, sessionID, frequency);
    return true;
  }
  ...
  advance (numFrames)
  {
    this.byteMemory.fill (0, 76864, 76864 + numFrames * 4);
  ...
  */
  ...
  {
    this._pack_f32 (78912, newValue);
    this.instance.exports._setValue_shape (74592, 78912, numFramesToReachValue);
  }
  ...
  {
    this.instance.exports._sendEvent_rate (74592, eventValue);
  }
  ...
  {
    this.instance.exports._sendEvent_depth (74592, eventValue);
  }
  ...
  */
  ...
  {
    this._pack_b (78912, newValue);
    this.instance.exports._setValue_bypass (74592, 78912, numFramesToReachValue);
  }
  ...
  {
    return this.memoryDataView.getFloat32 (76864 + frameIndex * 4, true);
  }
