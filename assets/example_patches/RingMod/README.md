### Auto-generated HTML & Javascript for Cmajor Patch "Ring Mod Demo"
...
- `cmaj_Ring_Mod_Demo.js` - this is the Javascript wrapper class for the patch, encapsulating its
